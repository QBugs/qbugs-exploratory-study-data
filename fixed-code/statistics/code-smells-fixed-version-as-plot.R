...
# Usage:
#   Rscript code-smells-fixed-version-as-plot.R
#     <input data file, e.g., ../data/generated/code-smell-metrics-for-fixed-data.csv>
#     <output pdf file, e.g., code-smells-fixed-version-as-plot.pdf>
# ------------------------------------------------------------------------------
...
if (length(args) != 2) {
  stop('USAGE: Rscript code-smells-fixed-version-as-plot.R <input data file, e.g., ../data/generated/code-smell-metrics-for-fixed-data.csv> <output pdf file, e.g., code-smells-fixed-version-as-plot.pdf>')
}

# Args
FIXED_CODE_SMELLS <- args[1]
OUTPUT_FILE <- args[2]

# ------------------------------------------------------------------------- Main

# Load data
fix_df <- load_CSV(FIXED_CODE_SMELLS)
head(fix_df)

## Filter data by metric values above the ones proposed in pysmell paper
tmp_df <- fix_df[(fix_df$code_smell_metric == 'PAR' & fix_df$code_smell_metric_value >= 5) | (fix_df$code_smell_metric == 'MLOC' & fix_df$code_smell_metric_value >= 100) | (fix_df$code_smell_metric == 'DOC' & fix_df$code_smell_metric_value >= 3) | (fix_df$code_smell_metric == 'NBC' & fix_df$code_smell_metric_value >= 3) | (fix_df$code_smell_metric == 'CLOC' & fix_df$code_smell_metric_value >= 200) | (fix_df$code_smell_metric == 'LMC' & fix_df$code_smell_metric_value >= 4) | (fix_df$code_smell_metric == 'NOC' & fix_df$code_smell_metric_value >= 80) | (fix_df$code_smell_metric == 'NOO' & fix_df$code_smell_metric_value >= 6) | (fix_df$code_smell_metric == 'TNOC' & fix_df$code_smell_metric_value >= 46) | (fix_df$code_smell_metric == 'LPAR' & fix_df$code_smell_metric_value >= 1) | (fix_df$code_smell_metric == 'TNOL' & fix_df$code_smell_metric_value >= 1) | (fix_df$code_smell_metric == 'CNOC' & fix_df$code_smell_metric_value >= 49) | (fix_df$code_smell_metric == 'NOFF' & fix_df$code_smell_metric_value >= 1) | (fix_df$code_smell_metric == 'CNOO' & fix_df$code_smell_metric_value >= 10) | (fix_df$code_smell_metric == 'LEC' & fix_df$code_smell_metric_value >= 3) | (fix_df$code_smell_metric == 'DNC' & fix_df$code_smell_metric_value >= 2) | (fix_df$code_smell_metric == 'NCT' & fix_df$code_smell_metric_value >= 1)  , ]
