...
## [RQ5_data.csv](generated/RQ5_data.csv)

File automatically generated by the notebook/script [RQ5_Data_Collection.ipynb](../scripts/RQ5_Data_Collection.ipynb).

- `Bug ID`: Bug id as original identified in the [Bugs in Quantum Computing Platforms: An Empirical Study](https://arxiv.org/abs/2110.14560) 
  * factor, e.g., "1", "1909-5" 
...
- `File`: name of the fixed file
  * factor: e.g., "cvx_fit.py"

- `Hash`: commit hash of the fix commit associated to the bug
  * factor, e.g., "ec1b4ce759f1fb8ba0242dd6c4a309fa1b586666"
