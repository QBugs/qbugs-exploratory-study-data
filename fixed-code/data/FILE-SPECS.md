...
## [loc-fix-commits.csv](generated/loc-fix-commits.csv)

File automatically generated by the script [compute-loc-fix-commits.sh](../scripts/compute-loc-fix-commits.sh).
...
- `number_loc_added`: number of lines of code inserted in a specific commit
  * numerical, e.g., 10

- `number_loc_deleted`: number of lines of code deleted in a specific commit
  * numerical, e.g., 5
