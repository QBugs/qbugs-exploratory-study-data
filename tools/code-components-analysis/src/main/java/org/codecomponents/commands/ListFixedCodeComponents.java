...
/**
 * The <code>listFixedCodeComponents</code> command.
 */
public class ListFixedCodeComponents extends Command {
    ...
    private File outputFile = new File("fixed-code-components.csv");
    ...
    public String description() {
        return "List the set of fixed components in a diff.";
    }
    ...
    @Override
    public String name() {
        return "listFixedCodeComponents";
    }
    ...
    public int execute(final PrintStream out, final PrintStream err) throws Exception {
        ...
        for (Component component : GumTreeDiffWrapper.getInstance(this.buggyFile, this.fixedFile).findFixedComponents()) {
